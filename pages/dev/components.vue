  ...
  <div v-if="isDev" class="min-h-screen">
    ...
    <div class="bg-primary py-6 px-4 mb-8">
      <div class="max-w-7xl mx-auto">
        <h1 class="text-3xl font-bold" style="color: var(--color-btn-primary-text)">Component Showcase</h1>
        <p class="text-sm opacity-80 mt-1" style="color: var(--color-btn-primary-text)">Componentes REALES de la aplicación - Solo visible en desarrollo</p>
      </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 pb-12">
      ...
      <!-- ==================== THEME SELECTOR ==================== -->
      <section class="mb-12">
        <h2 class="section-title"><Icon name="fa6-solid:palette" class="text-primary" aria-hidden="true" /> Selector de Tema</h2>
        <div class="card p-6">
          <div class="flex flex-wrap gap-2 mb-4">
            <button
              ...
              :class="currentTheme === theme.name ? 'bg-primary border-primary' : 'border-gray-300 dark:border-gray-600 hover:border-primary'"
      ...
      <!-- ==================== PAGE HEADER ==================== -->
      <section class="mb-12">
        <h2 class="section-title"><Icon name="fa6-solid:heading" class="text-primary" aria-hidden="true" /> Page Header</h2>
        <div class="card p-6 space-y-6">
          <PageHeader title="Título de página" description="Descripción opcional de la página" icon="house" />
          <PageHeader title="Sin descripción" icon="gear" />
          <PageHeader title="Solo título" />
        </div>
        <p class="text-sm text-gray-500 mt-2">Componente: <code>components/ui/PageHeader.vue</code></p>
      </section>

      <!-- ==================== LOGO ==================== -->
      <section class="mb-12">
        <h2 class="section-title"><Icon name="fa6-solid:image" class="text-primary" aria-hidden="true" /> Logo</h2>
        <div class="card p-6">
          ...
          <p class="text-sm text-gray-500 mt-4">Componente: <code>components/common/Logo.vue</code></p>
        </div>
      </section>

      <!-- ==================== LOADING SPINNER ==================== -->
      <section class="mb-12">
        <h2 class="section-title"><Icon name="fa6-solid:spinner" class="text-primary" aria-hidden="true" /> Loading Spinner</h2>
        <div class="card p-6">
          ...
          <div class="flex items-center gap-8 mt-6 flex-wrap">
            <div v-for="color in ['primary', 'white', 'neutral', 'current']" :key="color" :class="color === 'white' ? 'bg-gray-800 p-2 rounded' : ''">
              <p class="text-xs text-gray-500 mb-2">{{ color }}</p>
              <LoadingSpinner :color="color" />
            </div>
          </div>
          <p class="text-sm text-gray-500 mt-4">Componente: <code>components/common/LoadingSpinner.vue</code></p>
        </div>
      </section>

      <!-- ==================== TIME AGO ==================== -->
      <section class="mb-12">
        <h2 class="section-title"><Icon name="fa6-solid:clock" class="text-primary" aria-hidden="true" /> Time Ago</h2>
        <div class="card p-6">
          <div class="space-y-2">
          ...
          <p class="text-sm text-gray-500 mt-4">Componente: <code>components/ui/TimeAgo.vue</code></p>
        </div>
      </section>

      <!-- ==================== AUTHOR INFO ==================== -->
      <section class="mb-12">
        <h2 class="section-title"><Icon name="fa6-solid:user" class="text-primary" aria-hidden="true" /> Author Info</h2>
        <div class="card p-6">
          <div class="space-y-4">
            <div>
            ...
            <div>
              ...
              <AuthorInfo :user="null" :created-at="mockDate" :show-time="true" :is-anonymous="true" author-name="Anónimo" />
            </div>
            <div>
          ...
          <p class="text-sm text-gray-500 mt-4">Componente: <code>components/common/AuthorInfo.vue</code></p>
        </div>
      </section>

      <!-- ==================== USER INFO CARD ==================== -->
      <section class="mb-12">
        <h2 class="section-title"><Icon name="fa6-solid:id-card" class="text-primary" aria-hidden="true" /> User Info Card</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <UserInfoCard :user="mockUserProfile" />
          <UserInfoCard :user="mockAdminProfile" />
        </div>
        <p class="text-sm text-gray-500 mt-2">Componente: <code>components/profile/UserInfoCard.vue</code></p>
      </section>

      <!-- ==================== LANGUAGE SELECTOR ==================== -->
      <section class="mb-12">
        <h2 class="section-title"><Icon name="fa6-solid:globe" class="text-primary" aria-hidden="true" /> Language Selector</h2>
        <div class="card p-6">
          <LanguageSelector />
          <p class="text-sm text-gray-500 mt-4">Componente: <code>components/common/LanguageSelector.vue</code></p>
        </div>
      </section>

      <!-- ==================== CONTENT LANGUAGE SELECTOR ==================== -->
      <section class="mb-12">
        <h2 class="section-title"><Icon name="fa6-solid:language" class="text-primary" aria-hidden="true" /> Content Language Selector</h2>
        <div class="card p-6">
          <ContentLanguageSelector v-model="selectedLanguage" />
          <p class="text-sm text-gray-500 mt-4">Seleccionado: <code>{{ selectedLanguage }}</code></p>
          <p class="text-sm text-gray-500">Componente: <code>components/common/ContentLanguageSelector.vue</code></p>
        </div>
      </section>

      <!-- ==================== LAYOUT SELECTOR ==================== -->
      <section class="mb-12">
        <h2 class="section-title"><Icon name="fa6-solid:table-cells" class="text-primary" aria-hidden="true" /> Layout Selector</h2>
        <div class="card p-6">
          <div class="flex items-center gap-4">
            <span class="text-sm text-gray-500">Vista de posts:</span>
            <LayoutSelector />
          </div>
          <p class="text-sm text-gray-500 mt-4">Componente: <code>components/posts/LayoutSelector.vue</code></p>
        </div>
      </section>

      <!-- ==================== VOTE BADGE ==================== -->
      <section class="mb-12">
        <h2 class="section-title"><Icon name="fa6-solid:square-poll-vertical" class="text-primary" aria-hidden="true" /> Vote Badge</h2>
        <div class="card p-6">
          ...
          <p class="text-sm text-gray-500 mt-4">Componente: <code>components/posts/VoteBadge.vue</code></p>
        </div>
      </section>

      <!-- ==================== VOTE CONTROLS ==================== -->
      <section class="mb-12">
        <h2 class="section-title"><Icon name="fa6-solid:arrows-up-down" class="text-primary" aria-hidden="true" /> Vote Controls</h2>
        <div class="card p-6">
          <div class="flex gap-8 flex-wrap items-start">
            ...
            <div>
              ...
              <VoteControls :item-id="2" :votes-count="23" :user-vote="1" user-vote-type="interesting" item-type="comment" />
            </div>
            <div>
              <p class="text-xs text-gray-500 mb-2">Voto negativo</p>
              <VoteControls :item-id="3" :votes-count="-5" :user-vote="-1" user-vote-type="irrelevant" item-type="comment" />
            </div>
          </div>
          <p class="text-sm text-gray-500 mt-4">Componente: <code>components/comments/VoteControls.vue</code></p>
        </div>
      </section>

      <!-- ==================== SEAL CORNER BADGE ==================== -->
      <section class="mb-12">
        <h2 class="section-title"><Icon name="fa6-solid:award" class="text-primary" aria-hidden="true" /> Seal Corner Badge</h2>
        <div class="card p-6">
          ...
          <p class="text-sm text-gray-500 mt-4">Componente: <code>components/seals/SealCornerBadge.vue</code></p>
        </div>
      </section>

      <!-- ==================== POST CARD ==================== -->
      <section class="mb-12">
        <h2 class="section-title"><Icon name="fa6-solid:newspaper" class="text-primary" aria-hidden="true" /> Post Card</h2>
        <div class="space-y-4">
          <div>
        ...
        <p class="text-sm text-gray-500 mt-4">Componente: <code>components/posts/PostCard.vue</code></p>
      </section>

      <!-- ==================== NSFW CONTENT WARNING ==================== -->
      <section class="mb-12">
        <h2 class="section-title"><Icon name="fa6-solid:eye-slash" class="text-primary" aria-hidden="true" /> NSFW Content Warning</h2>
        <div class="card p-6">
          <div class="max-w-md">
            <NSFWContentWarning :post="mockNSFWPost" :show-full-text="false">
              <template #default="{ showContent }">
                ...
                <div v-else class="p-4 bg-gray-100 dark:bg-gray-800 rounded">
                  Contenido oculto
                </div>
              </template>
            </NSFWContentWarning>
          </div>
          <p class="text-sm text-gray-500 mt-4">Componente: <code>components/posts/NSFWContentWarning.vue</code></p>
        </div>
      </section>

      <!-- ==================== COMMENT ITEM ==================== -->
      <section class="mb-12">
        <h2 class="section-title"><Icon name="fa6-solid:comment" class="text-primary" aria-hidden="true" /> Comment Item</h2>
        <div class="card">
          <CommentItem :comment="mockComment" :post-author-id="1" />
        </div>
        <p class="text-sm text-gray-500 mt-4">Componente: <code>components/comments/CommentItem.vue</code></p>
      </section>

      <!-- ==================== NOTIFICATION ITEM ==================== -->
      <section class="mb-12">
        <h2 class="section-title"><Icon name="fa6-solid:bell" class="text-primary" aria-hidden="true" /> Notification Item</h2>
        ...
        <p class="text-sm text-gray-500 mt-4">Componente: <code>components/notifications/NotificationItem.vue</code></p>
      </section>

      <!-- ==================== ERROR DISPLAY ==================== -->
      <section class="mb-12">
        <h2 class="section-title"><Icon name="fa6-solid:circle-exclamation" class="text-primary" aria-hidden="true" /> Error Display</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <ErrorDisplay type="generic" custom-title="Error personalizado" custom-message="Este es un mensaje de error personalizado" :show-action="false" />
        </div>
        <p class="text-sm text-gray-500 mt-4">Componente: <code>components/ui/ErrorDisplay.vue</code></p>
      </section>

      <!-- ==================== CONFIRM DIALOG ==================== -->
      <section class="mb-12">
        <h2 class="section-title"><Icon name="fa6-solid:circle-question" class="text-primary" aria-hidden="true" /> Confirm Dialog</h2>
        <div class="card p-6">
          ...
          />
          <p class="text-sm text-gray-500 mt-4">Componente: <code>components/common/ConfirmDialog.vue</code></p>
        </div>
      </section>

      <!-- ==================== REGISTRATION CTAs ==================== -->
      <section class="mb-12">
        <h2 class="section-title"><Icon name="fa6-solid:user-plus" class="text-primary" aria-hidden="true" /> Registration CTAs</h2>
        <div class="space-y-6">
          <div>
        ...
        <p class="text-sm text-gray-500 mt-4">Componentes: <code>components/common/*RegistrationCTA.vue</code></p>
      </section>

      <!-- ==================== SEAL BUTTON ==================== -->
      <section class="mb-12">
        <h2 class="section-title"><Icon name="fa6-solid:certificate" class="text-primary" aria-hidden="true" /> Seal Button</h2>
        <div class="card p-6">
          ...
          <p class="text-sm text-gray-500 mt-4">Componente: <code>components/seals/SealButton.vue</code></p>
        </div>
      </section>

      <!-- ==================== FILTER CONTROLS ==================== -->
      <section class="mb-12">
        <h2 class="section-title"><Icon name="fa6-solid:filter" class="text-primary" aria-hidden="true" /> Filter Controls</h2>
        <div class="card p-6">
          <FilterControls
          ...
          />
          <p class="text-sm text-gray-500 mt-4">Sort: <code>{{ currentSort }}</code>, Time: <code>{{ currentTimeRange }}</code></p>
          <p class="text-sm text-gray-500">Componente: <code>components/posts/FilterControls.vue</code></p>
        </div>
      </section>

      <!-- ==================== PLATFORM STATS ==================== -->
      <section class="mb-12">
        <h2 class="section-title"><Icon name="fa6-solid:chart-bar" class="text-primary" aria-hidden="true" /> Platform Stats</h2>
        <div class="card p-6">
          <PlatformStats />
          <p class="text-sm text-gray-500 mt-4">Componente: <code>components/stats/PlatformStats.vue</code></p>
        </div>
      </section>

      <!-- ==================== COOKIE BANNER ==================== -->
      <section class="mb-12">
        <h2 class="section-title"><Icon name="fa6-solid:cookie-bite" class="text-primary" aria-hidden="true" /> Cookie Banner</h2>
        <div class="card p-6">
          <p class="text-sm text-gray-500 mb-4">El banner de cookies se muestra automáticamente si no se ha aceptado. Vista previa del estilo:</p>
          <div class="border rounded-lg overflow-hidden" style="border-color: var(--color-border-default);">
            <div class="p-4" style="background-color: var(--color-bg-card); border-top: 3px solid var(--color-primary);">
              <div class="flex items-start gap-3">
                <Icon name="fa6-solid:cookie-bite" class="text-primary text-xl flex-shrink-0 mt-1" aria-hidden="true" />
                <div class="flex-1">
                  <h4 class="font-semibold mb-1">Uso de Cookies</h4>
                  <p class="text-sm text-gray-600 dark:text-gray-400 mb-3">Este sitio utiliza únicamente cookies esenciales necesarias para el funcionamiento básico. No usamos cookies de seguimiento, analíticas ni publicitarias.</p>
          ...
          <p class="text-sm text-gray-500 mt-4">Componente: <code>components/legal/CookieBanner.vue</code></p>
        </div>
      </section>

      <!-- ==================== UI PRIMITIVES (Generic) ==================== -->
      <section class="mb-12">
        <h2 class="section-title"><Icon name="fa6-solid:puzzle-piece" class="text-primary" aria-hidden="true" /> Primitivos UI (Estilos base)</h2>
        <div class="card p-6 space-y-6">
          <div>
            <h3 class="subsection-title">Botones (clases CSS)</h3>
            <div class="flex flex-wrap gap-3">
              <button class="btn-primary px-4 py-2 rounded-md">btn-primary</button>
              <button class="bg-primary px-4 py-2 rounded-md" style="color: var(--color-btn-primary-text)">bg-primary</button>
              <button class="border border-primary text-primary px-4 py-2 rounded-md hover:bg-primary hover:text-white transition-colors">Outline</button>
          ...
          <div>
            ...
            <div class="space-y-2">
              <div class="bg-green-100 dark:bg-green-900/30 border border-green-400 dark:border-green-700 text-green-700 dark:text-green-300 px-4 py-3 rounded-md">
                <Icon name="fa6-solid:circle-check" class="mr-2" aria-hidden="true" /> Mensaje de éxito - Todo ha ido bien.
              </div>
              <div class="bg-red-100 dark:bg-red-900/30 border border-red-400 dark:border-red-700 text-red-700 dark:text-red-300 px-4 py-3 rounded-md">
                <Icon name="fa6-solid:circle-xmark" class="mr-2" aria-hidden="true" /> Mensaje de error - Algo ha fallado.
              </div>
              <div class="bg-yellow-100 dark:bg-yellow-900/30 border border-yellow-400 dark:border-yellow-700 text-yellow-700 dark:text-yellow-300 px-4 py-3 rounded-md">
                <Icon name="fa6-solid:triangle-exclamation" class="mr-2" aria-hidden="true" /> Advertencia - Ten cuidado.
              </div>
              <div class="bg-blue-100 dark:bg-blue-900/30 border border-blue-400 dark:border-blue-700 text-blue-700 dark:text-blue-300 px-4 py-3 rounded-md">
                <Icon name="fa6-solid:circle-info" class="mr-2" aria-hidden="true" /> Información - Dato importante.
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input type="text" placeholder="Placeholder text" class="input-field border-primary" >
              </div>
            </div>
          ...
          <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div class="card p-4">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">Contenido de ejemplo para una card básica.</p>
          ...
          <div>
            ...
            <div class="flex flex-wrap gap-2">
              <span class="px-3 py-1 rounded-full text-sm" style="background-color: var(--color-primary); color: var(--color-btn-primary-text)">Primary</span>
          ...
          <div>
            ...
            <div class="space-y-2">
              ...
              <p class="text-base">Párrafo normal - text-base. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
...
const mockPost = {
  ...
  content: 'Este es el contenido del post. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
...
const mockComment = {
  id: 1,
  hex_id: '1',
  content: 'Este es un comentario de ejemplo. Me parece muy interesante el tema que has compartido. Lorem ipsum dolor sit amet, consectetur adipiscing elit.',
  created_at: '2025-01-15T12:00:00.000Z',
  votes_count: 12,
  user_has_voted: false,
  user: mockUser,
