...
<script setup>
  ...
  // SEO
  useSeoMeta({
    title: `${t('sections.pending')} - ${runtimeConfig.public.appName}`,
    description: t('sections.pending_description'),
    ogTitle: `${t('sections.pending')} - ${runtimeConfig.public.appName}`,
    ogDescription: t('sections.pending_description'),
    ogImage: ogImageUrl,
    ogUrl: `${siteUrl}/pending`,
    ogType: 'website',
    ogSiteName: runtimeConfig.public.appName,
    twitterCard: 'summary_large_image',
    twitterTitle: `${t('sections.pending')} - ${runtimeConfig.public.appName}`,
    twitterDescription: t('sections.pending_description'),
  ...
  // ============================================
  const { data: initialPostsData } = await useAsyncData('pending-posts', async () => {
    ...
    try {
      ...
      console.error('SSR: Error fetching pending posts:', error)
      return {
        posts: [],
        meta: {
          current_page: 1,
