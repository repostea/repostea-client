<template>
  <div class="container mx-auto px-4 py-8">
    <div
      class="max-w-3xl mx-auto card-bg p-6 rounded-lg border border-border-color shadow-sm"
    >
      <h1 class="text-2xl font-semibold mb-4">{{ t('social.title') }}</h1>
