        ...
        >
          ...
          <div class="flex items-start justify-between mb-4">
            <div class="flex items-center gap-3">
              ...
              <h3
                id="seal-info-modal-title"
                class="text-lg font-bold text-text dark:text-text-dark"
              >
                {{ $t('seals.info_title') }}
              </h3>
            </div>
          ...
          <div class="space-y-4 text-sm text-text dark:text-text-dark">
            ...
            <div class="space-y-3">
              ...
              <div class="flex items-start gap-3 p-3 rounded-lg bg-green-50 dark:bg-green-900/20">
                <Icon
                  ...
                  class="text-xl text-green-600 dark:text-green-400 flex-shrink-0 mt-0.5"
                  aria-hidden="true"
                />
                <div>
              ...
              <div class="flex items-start gap-3 p-3 rounded-lg bg-orange-50 dark:bg-orange-900/20">
                <Icon
                  ...
                  class="text-xl text-orange-600 dark:text-orange-400 flex-shrink-0 mt-0.5"
                  aria-hidden="true"
                />
                <div>
                  ...
                  <p class="text-orange-600 dark:text-orange-400 text-xs mt-1">
                    {{ $t('seals.info_advise_against_desc') }}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="seal-info-divider pt-2">
              ...
              <ul
                class="list-disc list-inside space-y-1 text-text-muted dark:text-text-dark-muted text-xs"
              >
