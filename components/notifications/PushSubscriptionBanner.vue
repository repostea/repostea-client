<template>
  <div v-if="shouldShow" class="px-4 py-3 push-banner transition-all">
    <!-- Permission denied state -->
    <div v-if="isBlocked" class="flex items-start gap-3">
      <div
        class="flex-shrink-0 w-8 h-8 rounded-full bg-red-100 dark:bg-red-900/30 flex items-center justify-center"
      >
