<template>
  <div class="space-y-6">
    ...
    <div v-else>
      ...
      <div v-if="settings?.federation_enabled && settings?.handle" class="py-4 border-b settings-border">
      ...
      <div v-if="settings?.federation_enabled" class="flex items-center justify-between py-4 border-b settings-border">
        <div class="flex-1 mr-4">
